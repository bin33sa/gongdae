	...
	<div class="offcanvas-body p-0 d-flex flex-column h-100">
		...
		<div class="menu-header p-4">
			<div class="d-flex align-items-center">
				...
				<sec:authorize access="!hasRole('GUEST')">
					...
					<div>
						<a href="${pageContext.request.contextPath}/member/login"
							class="fw-bold fs-5 text-white"> 유저로<br>로그인/회원가입
						</a>
					</div>
				</sec:authorize>
				...
				<sec:authorize access="hasRole('GUEST')">
					...
					<div class="profile-img me-3">
						...
						<c:choose>
							<c:when test="${not empty member.avatar}">
								<img
									src="${pageContext.request.contextPath}/uploads/member/${member.avatar}"
					...
					<div>
						<div class="fw-bold fs-5 mb-1 text-white">${member.nickname != null ? member.nickname : member.name}
							님</div>

						<a href="${pageContext.request.contextPath}/guest/pwd"
							class="small  text-white"> 정보수정 </a> <span class="text-secondary">|</span>

						<a href="${pageContext.request.contextPath}/member/logout"
							class="small  text-white"> 로그아웃 </a>
					</div>
		...
		<sec:authorize access="hasRole('GUEST')">
			...
			<div class="icon-menu py-4">
				...
				<div class="row text-center g-0">
					...
					<div class="col-3"
						onclick="location.href='${pageContext.request.contextPath}/reservation/list'">
		...
		<div class="flex-grow-1 overflow-auto">
			...
			<ul class="menu-list list-unstyled m-0">
				...
				<li onclick="location.href='${pageContext.request.contextPath}/'">
					<i class="bi bi-house me-2"></i> 공대생 홈
				</li>

				<li
					onclick="location.href='${pageContext.request.contextPath}/space/search'">
					<i class="bi bi-search me-2"></i> 공간 찾기
				</li>
		...
		<div class="bottom-fixed bottom-fixed-host text-center mt-auto">
			...
			<a href="${pageContext.request.contextPath}/host/main/prelogin">
				호스트 센터로 이동 <i class="bi bi-arrow-right-circle ms-1"></i>
			</a>
