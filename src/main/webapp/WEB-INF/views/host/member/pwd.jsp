			...
			<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
				<div class="col-md-5">
					<div class="bg-white box-shadow my-5 p-5">
						...
						<form name="pwdForm" action="" method="post" class="row g-3 mb-2 pt-3">
							<div class="col-12">
...
function sendOk() {
	...
	if(! f.password.value.trim()) { alert('패스워드를 입력하세요.'); f.password.focus(); return; }

	f.action = '${pageContext.request.contextPath}/host/pwd';
	f.submit();
}
</script>
