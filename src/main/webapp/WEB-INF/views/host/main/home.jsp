...
<head>
    ...
    <style>
        ...
        .stat-title { font-size: 0.9rem; color: #666; margin-bottom: 8px; font-weight: 600; }
...
<body>
    ...
    <main class="dashboard-container mb-5">
        <%-- <sec:authentication property="principal.member" var="hostInfo"/> --%>

        <h2 class="page-title">안녕하세요, 호스트님! 공간 대여 현황입니다. <i class="bi bi-emoji-smile text-warning"></i></h2>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="stat-card">
                    ...
                    <div class="stat-value">
                        <fmt:formatNumber value="${sales.thisMonthSales}" pattern="#,###"/>
                        <span style="font-size:1rem; color:#888; font-weight:normal;"> 원</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="stat-card">
                    ...
                    <div class="stat-title">이번 달 예약 건수</div>
                    <div class="stat-value">
                        <fmt:formatNumber value="${sales.thisMonthResCount}" pattern="#,###"/>
                        <span style="font-size:1rem; color:#888; font-weight:normal;"> 건</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="stat-card">
                    <div class="stat-icon icon-yellow"><i class="bi bi-wallet2"></i></div>
                    <div class="stat-title">총 누적 매출</div>
                    <div class="stat-value">
                        <fmt:formatNumber value="${sales.totalSales}" pattern="#,###"/>
                        <span style="font-size:1rem; color:#888; font-weight:normal;"> 원</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="stat-card">
                    <div class="stat-icon icon-red"><i class="bi bi-people-fill"></i></div>
                    <div class="stat-title">총 누적 예약 건수</div>
                    <div class="stat-value">
                        <fmt:formatNumber value="${sales.totalResCount}" pattern="#,###"/>
                        <span style="font-size:1rem; color:#888; font-weight:normal;"> 건</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="content-card h-100">
                    <div class="content-header">
                        ...
                        <a href="<c:url value='/host/menu/reservation'/>" class="btn-more">전체보기 <i class="bi bi-chevron-right"></i></a>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="content-card h-100">
                    ...
                    <div class="d-grid gap-3">
                        <a href="<c:url value='/host/space/write'/>" class="btn btn-primary py-3 fw-bold" style="background-color: var(--host-primary); border: none;">
