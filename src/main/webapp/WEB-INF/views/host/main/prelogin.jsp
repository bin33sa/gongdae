    ...
    <section class="hero-section">
        <div class="container">
            ...
            <sec:authorize access="isAnonymous()">
                <a href="${pageContext.request.contextPath}/host/signup" class="btn btn-register text-decoration-none">호스트 가입하고 공간 등록하기</a>
            </sec:authorize>
            <sec:authorize access="isAuthenticated()">
                <a href="<c:url value='/host/signup'/>" class="btn btn-register text-decoration-none">내 공간 등록하기</a>
            </sec:authorize>
        </div>
    </section>
